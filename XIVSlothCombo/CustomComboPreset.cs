...
namespace XIVSlothComboPlugin
{
    ...
    public enum CustomComboPreset
    {
        ...
        [DependentCombos(MachinistMainCombo)]
        [CustomComboInfo("Alternate Drill/Air Feature on Main Combo", "Drill/Air/Hotshot/Chainsaw is added onto main combo.\n Drill/Chainsaw only added with Reassemble. \nRequires (Heated) Shot Combo.", MCH.JobID, MCH.Drill, MCH.AirAnchor, MCH.HotShot, MCH.Reassemble)]
