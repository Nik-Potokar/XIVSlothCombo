...
namespace XIVSlothComboPlugin
{
    ...
    public enum CustomComboPreset
    {
        ...
        */
        ...
        [CustomComboInfo("Jolt into Verproc", "Replaces Jolt with Verstone/Verfire, when proc is available and gauge is imbalanced.", RDM.JobID, 0, "Swiftcast -> Verraise", "Ah look, it's what you were always meant to do")]
