...
namespace XIVSlothCombo.Combos.JobHelpers
{
    ...
    {
        internal class MCHOpenerLogic100
        {
            private static bool HasCooldowns()
            {
                ...
                if (GetRemainingCharges(Drill) < 2)
                    return false;
        ...
        internal class MCHOpenerLogic96
        {
            private static bool HasCooldowns()
            {
                if (GetRemainingCharges(CheckMate) < 3)
            ...
            private bool DoOpener(ref uint actionID)
            {
                ...
                if (currentState == OpenerState.InOpener)
                {
                    ...
                    if (WasLastAction(DoubleCheck) && OpenerStep == 13) OpenerStep++;
                    else if (OpenerStep == 13) actionID = DoubleCheck;

                    if (WasLastAction(Hypercharge) && OpenerStep == 14) OpenerStep++;
                    else if (OpenerStep == 14) actionID = Hypercharge;

                    if (WasLastAction(BlazingShot) && OpenerStep == 15) OpenerStep++;
                    else if (OpenerStep == 15) actionID = BlazingShot;

                    if (WasLastAction(CheckMate) && OpenerStep == 16) OpenerStep++;
                    else if (OpenerStep == 16) actionID = CheckMate;

                    if (WasLastAction(BlazingShot) && OpenerStep == 17) OpenerStep++;
                    else if (OpenerStep == 17) actionID = BlazingShot;

                    if (WasLastAction(DoubleCheck) && OpenerStep == 18) OpenerStep++;
                    else if (OpenerStep == 18) actionID = DoubleCheck;

                    if (WasLastAction(BlazingShot) && OpenerStep == 19) OpenerStep++;
                    else if (OpenerStep == 19) actionID = BlazingShot;

                    if (WasLastAction(CheckMate) && OpenerStep == 20) OpenerStep++;
                    else if (OpenerStep == 20) actionID = CheckMate;

                    if (WasLastAction(BlazingShot) && OpenerStep == 21) OpenerStep++;
                    else if (OpenerStep == 21) actionID = BlazingShot;

                    if (WasLastAction(DoubleCheck) && OpenerStep == 22) OpenerStep++;
                    else if (OpenerStep == 22) actionID = DoubleCheck;

                    if (WasLastAction(BlazingShot) && OpenerStep == 23) OpenerStep++;
                    else if (OpenerStep == 23) actionID = BlazingShot;

                    if (WasLastAction(CheckMate) && OpenerStep == 24) OpenerStep++;
                    else if (OpenerStep == 24) actionID = CheckMate;

                    if (WasLastAction(Drill) && OpenerStep == 25) OpenerStep++;
                    else if (OpenerStep == 25) actionID = Drill;

                    if (WasLastAction(DoubleCheck) && OpenerStep == 26) OpenerStep++;
                    else if (OpenerStep == 26) actionID = DoubleCheck;

                    if (WasLastAction(CheckMate) && OpenerStep == 27) OpenerStep++;
                    else if (OpenerStep == 27) actionID = CheckMate;

                    if (WasLastAction(HeatedSplitShot) && OpenerStep == 28) OpenerStep++;
                    else if (OpenerStep == 28) actionID = HeatedSplitShot;

                    if (WasLastAction(DoubleCheck) && OpenerStep == 29) OpenerStep++;
                    else if (OpenerStep == 29) actionID = DoubleCheck;

                    if (WasLastAction(HeatedSlugShot) && OpenerStep == 30) OpenerStep++;
                    else if (OpenerStep == 30) actionID = HeatedSlugShot;

                    if (WasLastAction(HeatedCleanShot) && OpenerStep == 31) CurrentState = OpenerState.OpenerFinished;
        ...
        internal class MCHOpenerLogic94
        {
            private static bool HasCooldowns()
            {
                if (GetRemainingCharges(CheckMate) < 3)
            ...
            private bool DoOpener(ref uint actionID)
            {
                ...
                if (currentState == OpenerState.InOpener)
                {
                    ...
                    if (WasLastAction(HeatedSplitShot) && OpenerStep == 6) OpenerStep++;
                    else if (OpenerStep == 6) actionID = HeatedSplitShot;

                    if (WasLastAction(HeatedSlugShot) && OpenerStep == 7) OpenerStep++;
                    else if (OpenerStep == 7) actionID = HeatedSlugShot;

                    if (WasLastAction(DoubleCheck) && OpenerStep == 8) OpenerStep++;
                    else if (OpenerStep == 8) actionID = DoubleCheck;

                    if (WasLastAction(CheckMate) && OpenerStep == 9) OpenerStep++;
                    else if (OpenerStep == 9) actionID = CheckMate;

                    if (WasLastAction(HeatedCleanShot) && OpenerStep == 10) OpenerStep++;
                    ...
                    if (WasLastAction(Chainsaw) && OpenerStep == 13) OpenerStep++;
                    else if (OpenerStep == 13) actionID = Chainsaw;

                    if (WasLastAction(AutomatonQueen) && OpenerStep == 14) OpenerStep++;
                    ...
                    if (WasLastAction(Drill) && OpenerStep == 29) OpenerStep++;
        ...
        internal class MCHOpenerLogic92
        {
            private static bool HasCooldowns()
            {
                if (GetRemainingCharges(CheckMate) < 3)
        ...
        internal class MCHOpenerLogic90
        {
            private static bool HasCooldowns()
            {
                if (GetRemainingCharges(Ricochet) < 3)
                    return false;
            ...
            private bool DoOpener(ref uint actionID)
            {
                ...
                if (currentState == OpenerState.InOpener)
                {
                    ...
                    if (WasLastAction(Ricochet) && OpenerStep == 2) OpenerStep++;
                    else if (OpenerStep == 2) actionID = Ricochet;

                    if (WasLastAction(GaussRound) && OpenerStep == 3) OpenerStep++;
                    ...
                    if (WasLastAction(GaussRound) && OpenerStep == 8) OpenerStep++;
                    else if (OpenerStep == 8) actionID = GaussRound;

                    if (WasLastAction(Ricochet) && OpenerStep == 9) OpenerStep++;
                    ...
                    if (WasLastAction(Ricochet) && OpenerStep == 17) OpenerStep++;
                    else if (OpenerStep == 17) actionID = Ricochet;

                    if (WasLastAction(BlazingShot) && OpenerStep == 18) OpenerStep++;
                    else if (OpenerStep == 18) actionID = BlazingShot;

                    if (WasLastAction(GaussRound) && OpenerStep == 19) OpenerStep++;
                    else if (OpenerStep == 19) actionID = GaussRound;

                    if (WasLastAction(BlazingShot) && OpenerStep == 20) OpenerStep++;
                    else if (OpenerStep == 20) actionID = BlazingShot;

                    if (WasLastAction(Ricochet) && OpenerStep == 21) OpenerStep++;
                    else if (OpenerStep == 21) actionID = Ricochet;

                    if (WasLastAction(BlazingShot) && OpenerStep == 22) OpenerStep++;
                    else if (OpenerStep == 22) actionID = BlazingShot;

                    if (WasLastAction(GaussRound) && OpenerStep == 23) OpenerStep++;
                    else if (OpenerStep == 23) actionID = GaussRound;

                    if (WasLastAction(BlazingShot) && OpenerStep == 24) OpenerStep++;
                    else if (OpenerStep == 24) actionID = BlazingShot;

                    if (WasLastAction(Ricochet) && OpenerStep == 25) OpenerStep++;
                    else if (OpenerStep == 25) actionID = Ricochet;

                    if (WasLastAction(Drill) && OpenerStep == 26) OpenerStep++;
                    else if (OpenerStep == 26) actionID = Drill;

                    if (WasLastAction(GaussRound) && OpenerStep == 27) OpenerStep++;
                    else if (OpenerStep == 27) actionID = GaussRound;

                    if (WasLastAction(Ricochet) && OpenerStep == 28) OpenerStep++;
